...
.network-intro-content-tt .username-input-wrapper {
	box-shadow: 0 0 0 3px #EE1D52, 0 0 0 4px rgba(0, 0, 0, 0.3);
}
...
.network-intro-content-tt .button {
	box-shadow: 0 0 0 4px #EE1D52, 0 0 0 5px #fff;
}	
.button:hover {
...
@font-face {
  ...
  font-stretch: 100%;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/saira/v8/memjYa2wxmKQyPMrZX79wwYZQMhsyuSLh4vSZSk.woff2) format('woff2');
...
@font-face {
  ...
  font-stretch: 100%;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/saira/v8/memjYa2wxmKQyPMrZX79wwYZQMhsyuSLhovSZSk.woff2) format('woff2');
...
@font-face {
  ...
  font-stretch: 100%;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/saira/v8/memjYa2wxmKQyPMrZX79wwYZQMhsyuSLiIvS.woff2) format('woff2');
